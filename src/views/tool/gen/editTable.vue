<template>
  <el-card>
    <el-tabs v-model="activeName">
      <el-tab-pane :label="$t('common.tabBasicInfo')" name="basic">
        <basic-info-form ref="basicInfo" :info="info" />
      </el-tab-pane>
      <el-tab-pane :label="$t('common.tabFieldInfo')" name="columnInfo">
      ...
      <el-tab-pane :label="$t('common.tabGenInfo')" name="genInfo">
