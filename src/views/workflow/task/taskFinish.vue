  ...
  <div class="p-2 app-container workflow-task-finish-page">
    ...
    <el-card shadow="hover" class="table-panel">
      <template #header>
        <div class="toolbar-shell">
          <div class="table-heading">
            <h3>{{ $t('common.sectionFinishedTask') }}</h3>
          </div>
      ...
      >
        ...
        ></el-table-column>
        <el-table-column align="center" prop="flowName" width="120" :label="$t('common.processDefinitionName')"></el-table-column>
        ...
        ></el-table-column>
        <el-table-column align="center" prop="approverName" :label="$t('common.assignee')" min-width="180">
          <template #default="scope">
            <UserNameDisplay :content="scope.row.approverName" />
          </template>
        </el-table-column>
        <el-table-column align="center" :label="$t('common.processStatus')" prop="flowStatus" min-width="80">
          <template #default="scope">
            <dict-tag :options="wf_business_status" :value="scope.row.flowStatus"></dict-tag>
          </template>
        </el-table-column>
        <el-table-column align="center" :label="$t('common.taskStatus')" prop="flowTaskStatus" min-width="80">
          <template #default="scope">
